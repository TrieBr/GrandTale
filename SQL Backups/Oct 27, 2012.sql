...
CREATE TABLE IF NOT EXISTS `characters` (
  ...
  `combatStatsID` int(11) NOT NULL DEFAULT '1',
  `statPoints` int(11) NOT NULL DEFAULT '0' COMMENT 'Remaining stat points to spend',
...
-- Dumping structure for table triebrco_gtdata.combatstats
CREATE TABLE IF NOT EXISTS `combatstats` (
  ...
  `stat_base_atk` int(10) NOT NULL DEFAULT '0',
  `stat_base_magic_atk` int(10) NOT NULL DEFAULT '0',
  `stat_base_def` int(10) NOT NULL DEFAULT '0',
  `stat_base_magic_def` int(10) NOT NULL DEFAULT '0',
  `stat_base_hp` int(10) NOT NULL DEFAULT '0',
  `stat_bonus_hp` int(10) NOT NULL DEFAULT '0',
  `stat_base_mp` int(10) NOT NULL DEFAULT '0',
  `stat_bonus_mp` int(10) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `itemcustomizationdata` (
  ...
  `stat_base_atk` int(10) NOT NULL DEFAULT '0',
  `stat_bonus_atk` int(10) NOT NULL DEFAULT '0',
  `stat_base_magic_atk` int(10) NOT NULL DEFAULT '0',
  `stat_bonus_magic_atk` int(10) NOT NULL DEFAULT '0',
  ...
  `weapon_damage` int(10) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `mobs` (
  ...
  `combatStatsID` int(10) DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
