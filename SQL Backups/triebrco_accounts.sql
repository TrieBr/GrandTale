...
--
-- Host: localhost    Database: triebrco_accounts
-- ------------------------------------------------------
-- Server version	5.1.60-community-log

/*!40101 SET @OLD_CHAtriebrco_accountsRACTER_SET_CLIENT=@@CHARACTER_SET_CLIENT */;
/*!40101 SET @OLD_CHARACTER_SET_RESULTS=@@CHARACTER_SET_RESULTS */;
/*!40101 SET @OLD_COLLATION_triebrco_accountstriebrco_gtdatatriebrco_accountsCONNECTION=@@COLLATION_CONNECTION */;
...
CREATE TABLE `members` (triebrco_accounts
...
--
-- Dumping routines for database 'triebrco_accounts'
--
...
-- Dump completed on 2012-02-01 20:33:47
